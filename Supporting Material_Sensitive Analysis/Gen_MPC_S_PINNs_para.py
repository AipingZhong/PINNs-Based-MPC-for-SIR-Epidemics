...
if kappa == 1:
    output_dir = 'Plot/Gen_MPC_S_PINNs_kappa1_ideal_mpc_multi_param'
elif kappa == 0.001:
    output_dir = 'Plot/Gen_MPC_S_PINNs_kappa0.001_ideal_mpc_multi_param'
...
for gamma in gamma_values:
    for r_0 in r_0_values:
        ...
        epochs_data = epochs_data_values[(gamma, r_0)]  # epochs_data_values[(gamma, r_0)]
        beta = gamma * r_0
        repro = r_0
        ...
        for run in range(num_runs):
            ...
            print(f"Data regression completed, final epoch loss: {loss_data:.5e}")
