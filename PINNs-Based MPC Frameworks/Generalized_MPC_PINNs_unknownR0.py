...
epochs_ode_initial = 6000  # Number of epochs for the initial training
epochs_ode_reuse = 1200    # Number of epochs for training after reusing weights
...
if use_weight_reuse:
    if kappa == 1:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa1_beta_gamma_noR0_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa0.001_beta_gamma_noR0_reuse'
else:
    if kappa == 1:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa1_beta_gamma_noR0_no_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa0.001_beta_gamma_noR0_no_reuse'
