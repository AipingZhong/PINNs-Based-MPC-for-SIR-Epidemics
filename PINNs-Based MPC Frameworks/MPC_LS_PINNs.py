...
kappa = 1  # Noise regulation factor; or 0.01
...
epochs_ode_initial = 5000  # Number of epochs for the initial training
epochs_ode_reuse = 1000    # Number of epochs for training after reusing weights
...
if use_weight_reuse:
    if kappa == 1:
        output_dir = 'Plot/MPC_LS_PINNs_kappa1_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_LS_PINNs_kappa0.001_reuse'
else:
    if kappa == 1:
        output_dir = 'Plot/MPC_LS_PINNs_kappa1_no_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_LS_PINNs_kappa0.001_no_reuse'
