...
if use_weight_reuse:
    if kappa == 1:
        output_dir = 'Plot/MPC_PINNs_kappa1_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_PINNs_kappa0.001_reuse'
else:
    if kappa == 1:
        output_dir = 'Plot/MPC_PINNs_kappa1_no_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_PINNs_kappa0.001_no_reuse'
