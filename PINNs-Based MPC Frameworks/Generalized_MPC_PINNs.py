...
if use_weight_reuse:
    if kappa == 1:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa1_beta_gamma_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa0.001_beta_gamma_reuse'
else:
    if kappa == 1:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa1_beta_gamma_no_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/Gen_MPC_PINNs_kappa0.001_beta_gamma_no_reuse'
