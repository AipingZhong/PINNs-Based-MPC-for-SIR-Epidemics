...
epochs_data_reuse = 1800    # Number of epochs for data training after reusing weights
epochs_ode_reuse = 2000     # Number of epochs for ODE training after reusing weights
...
if use_weight_reuse:
    if kappa == 1:
        output_dir = 'Plot/MPC_SI_PINNs_kappa1_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_SI_PINNs_kappa0.001_reuse'
else:
    if kappa == 1:
        output_dir = 'Plot/MPC_SI_PINNs_kappa1_no_reuse'
    elif kappa == 0.001:
        output_dir = 'Plot/MPC_SI_PINNs_kappa0.001_no_reuse'
