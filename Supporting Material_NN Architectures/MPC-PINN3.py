...
for run in range(num_runs):
    ...
    # Multi-output neural network modeling S, I, and beta simultaneously
    S, I, Beta = sn.Functional(['S', 'I', 'Beta'], [t, u], 8 * [150], output_activation='sigmoid')
    ...
    loss_train_ode = ['zeros'] * 6 + [(t_ode, I_obs_k)]
    ...
    beta_est_full = Beta.eval(pinn_ode, [t_data_sc_k.reshape(-1, 1), u_train_k]).flatten()
    ...
    beta_est_runs[0:tf_int + 1, run] = beta_est_full[0:tf_int + 1]
...
if kappa == 1:
    output_dir = 'Plot/MPC_PINN3_kappa1_ideal_mpc'
