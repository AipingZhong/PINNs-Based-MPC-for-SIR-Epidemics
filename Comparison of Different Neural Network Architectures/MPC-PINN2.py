...
epochs_ode = 4000  # Epochs for physics-informed training # Result of epochs 5000 is more worse and more time-consuming.
...
for run in range(num_runs):
    ...
    # Multi-output neural network modeling S, I, u, and beta simultaneously
    S, I, u, Beta = sn.Functional(['S', 'I', 'u', 'Beta'], t, 8 * [150], output_activation='sigmoid')
    ...
    beta_est_full = Beta.eval(pinn_ode, t_data_sc_k.reshape(-1, 1)).flatten()
...
if kappa == 1:
    output_dir = 'Plot/MPC_PINN2_kappa1_ideal_mpc'
